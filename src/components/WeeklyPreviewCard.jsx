  ...
  return (
    <section className="task-card home-card">
      ...
      <div className="summary-stack">
        ...
        <p className="settings-copy">A lightweight snapshot for the week ahead. Replace these placeholders with real scheduling data when ready.</p>
      </div>
export default function WeeklyPreviewCard({ inboxCount = 0, plannedCount = 0, activeCount = 0, doneCount = 0 }) {
  const copy = {
